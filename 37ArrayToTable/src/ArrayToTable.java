...
//	1	System.out.println("Index\tРік\tКраїна і місто");
...
//		}
		...
		boolean znajdeno = false; // спочатку ніодного совпадіння не знаїдено
/*для*/for(int j=0; j<igry.length; j++)
		{
/*якщо*/	if(igry[j]==rik)
			{
/*то*/		System.out.print(j+"\t");
			System.out.print(igry[j]+"\t");
			System.out.print(krajina[j]+ " - " + misto[j] + "\n");
			znajdeno = true;
			}
		}
/*якщо*/ if(!znajdeno)	// недорівнює істині (znajdeno!=true) або (znajdeno==false)
		{
/*то*/		System.out.println("Вибачте, у введеному році олімпійских ігор не відбувалось");
		}
	}
